...
data = dict(
    ...
    train=dict(
        ...
        data_prefix=data_root + 'data/downloaded',
        pipeline=train_pipeline,
        test_mode=False),
    val=dict(
        type=dataset_type,
...
log_level = 'INFO'
work_dir = './work_dirs/gl_256x256_8x12_manga'
load_from = None
resume_from = None
...
# python tools/train.py configs/inpainting/global_local/gl_256x256_8x12_manga.py